...
running an audit against GitHub, GitLab, AWS, or Azure DevOps — pick a platform,
enter connection details, choose which checks to run, and watch live progress.
...
| =applications/azure_devops/= | Azure DevOps users, group memberships, repos, branch policies, service connections |
